        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/**").permitAll()
                                ...
                                .requestMatchers("/api/hoa-don/cap-nhat-trang-thai/khach-hang-huy/**").hasRole("KHACH_HANG")
                                .requestMatchers("/api/voucher/active").hasAnyRole("KHACH_HANG","NHAN_VIEN","ADMIN")
                                .requestMatchers("/api/admin/voucher/apply").hasRole("KHACH_HANG")
                        ...
                        .requestMatchers("/api/admin/**").hasAnyRole("ADMIN","NHAN_VIEN")
                                .requestMatchers("/api/hoa-don/**").hasAnyRole("ADMIN","NHAN_VIEN")
                                .requestMatchers("/api/ship/**").hasAnyRole("ADMIN")
